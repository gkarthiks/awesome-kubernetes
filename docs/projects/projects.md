...
* [k8s-discovery](https://github.com/gkarthiks/k8s-discovery/) - Auto discover the running environment and serves the GoLang Kubernetes clientset interface for interaction with the cluster
